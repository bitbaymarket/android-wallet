...
function printNewWindowClose(divName){
  w=window.open();
  w.document.write($('#' + divName).html());
  w.print();
  w.close();              
...
$(document).ready(function() {
  ...
  //testing why extrenal links don't open same way as #print click Below
  //the actually open inside the app 
  $('.externalLink').on('click', function (e) {
    var href = $(this).attr("href");
    window.open(href,"");
	});  
  $('.externalLink2').on('click', function (e) {
    var href = $("#walletHistory").attr("href");
    window.open(href,"_blank");
	});  
  $('.externalLink3').on('click', function (e) {
    var href = $("#walletHistory").attr("href");
    window.open(href,"_top");
	});  
  $('.externalLink4').on('click', function (e) {
    var href = $("#walletHistory").attr("href");
    w = window.open();
    w.location.href = href;
	});  
  $('#print').on('click', function (e) {
    var print = getWalletInfo();
  ...
  $('#printClose').on('click', function (e) {
    var print = getWalletInfo();
    $("#printArea").html(print.join(""));
    printNewWindowClose("printArea");
	});
  $('#printLocal').on('click', function (e) {
    var print = getWalletInfo();
    var param = encodeURIComponent(btoa(print.join("")));
    window.open("./print.html?body="+param,"");
	});
  $('#printURL').on('click', function (e) {
    var print = getWalletInfo();
    var param = encodeURIComponent(btoa(print.join("")));
    window.open("https://wallet.bitbay.market/print.html?body="+param,"");
	});
  $('#printSystemURL').on('click', function (e) {
    var print = getWalletInfo();
    var param = encodeURIComponent(btoa(print.join("")));
    //https://cordova.apache.org/docs/en/latest/reference/cordova-plugin-inappbrowser/
    cordova.InAppBrowser.open("https://wallet.bitbay.market/print.html?body="+param,"_blank");
	});
  $('#printSystemLocal').on('click', function (e) {
    var print = getWalletInfo();
    var param = encodeURIComponent(btoa(print.join("")));
    cordova.InAppBrowser.open("./print.html?body="+param,"_blank");
	});
